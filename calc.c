 ...
 * 	(EXPR*EXPR)
 *
 * where + means addition and * mean multiplication.
 *
 ...
 * non-digit and return it. Returns 0 if there are not digits. */
...
/* read and expression from stdin and return its value */
/* returns EXPRESSION_ERROR or error */
