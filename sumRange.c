#include <stdio.h>	/* This is needed to get the declarations of fprint and printf */
...
int sumRange(int start, int end)
{
    ...
    /* This exists the function immediately,
...
int main(int argc, char **argv)
{
    ...
    int end; 	/* one pas the last value in the range */
     ...
     * (which mean we can get it using argv[0]). */
    if(argc != 3) {
