...
/* directions for doubly-linked list next poiters */
#define RIGHT (0)
#define LEFT (1)
...
/* comment: listRemove could be implementd as listSplit(e,e) */
